...
model_config = {
  "architecture": "SegNet",
  "learning_rate": 0.001,
  "output_model_path": f"./model/NN/DA/SegNet_cross-validation/model_{model_id}/untrained-model.hdf5",
  "output_model_json_path": f"./model/NN/DA/SegNet_cross-validation/model_{model_id}/untrained-model.json",
...
training_config = {
  "output_model_path": f"./model/NN/DA/SegNet_cross-validation/model_{model_id}/trained-model.hdf5",
  "output_model_json_path": f"./model/NN/DA/SegNet_cross-validation/model_{model_id}/trained-model.json",
